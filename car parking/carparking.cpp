...
class Vehicle:public VehicleType{
    ...
    public:
        Vehicle(){
            ...
            strcpy(this->createdBy,"");
            strcpy(this->lastUpdatedBy,"");
            time_t tt;
            time(&tt);
        ...
        void showVehicle(){
            ...
            cout<<"Arrival time:"<<createdDateTime<<"Last Updated on:"<<lastUpdatedDateTime<<endl;
...
int menu(){
	...
	printf("\t\t\xdb                                               \xdb\n");
	printf("\t\t\xdb      CONTACT US:9108565740,8073322035         \xdb\n");
    ...
    while(1){
        ...
        switch(menu()){
            case 1:
                ...
                break;
            case 2:
                cout<<"\nEnter The Coupon Number To Searched: ";
                cin>>vno;
                vehicle.searchVehicle(vno);
                getch();
                break;
            case 3:
                cout<<"\nEnter The Coupon Number To Deleted: ";
                cin>>vno;
                vehicle.deleteVehicle(vno);
                getch();
                break;
            case 4:
                cout<<"\nEnter The Coupon Number To Updated: ";
                cin>>vno;
